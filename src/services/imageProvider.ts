...
export const getImage = async (descriptor: ImageDescriptor): Promise<ProvidedImage> => {
  try {
    ...
    if (cached) {
      ...
      return {
        ...cached,
        sourceUrl: cached.sourceUrl === 'cache://unknown' ? descriptor.imageUri : cached.sourceUrl,
        wasCached: true,
      };
    }
